...
class Usuario
{
    ...
    private function __construct($nombre, $apellido, $nombre_usuario, $correo, $password, $img, $rol)
    {
        $this->nombre = $nombre;
...
//REGISTRO Y LOGIN ////////////////////////////////////////////////////////////////////////
        ...
        public static function crea($nombre, $apellido, $nombreUsuario, $correo, $password, $aptitudes)
        {
            ...
            $usuario = new Usuario($nombre, $apellido, $nombreUsuario, $correo, self::hashPassword($password), NULL, 'user');
    ...
    {        
        ...
        $usuario = self::buscaUsuario($correo);
            ...
            if ($usuario && $usuario->compruebaPassword($password, $usuario->password)) {
                ...
                $_SESSION['id_usuario'] = Usuario::buscaIdUsuario($usuario->nombre_usuario);
    ...
    public static function buscaUsuario($correo)
    {
        ...
        if ($rs) {
            ...
            $fila = $rs->fetch_assoc();
            if ($fila) {
                $usuario = new Usuario($fila['nombre'], $fila['apellido'], $fila['nombre_usuario'], $fila['correo'], $fila['clave'], $fila['imagen'], $fila['rol']);
    ...
    public static function buscaNombreUsuario($nombreUsuario)
    {
        $conn = Aplicacion::getInstance()->getConexionBd();
        $result = false;
    ...
    public static function buscaCorreo($correo)
    {
        $conn = Aplicacion::getInstance()->getConexionBd();
        $result = false;
    ...
    public static function buscaInfoUsuario($idUsuario){
        ...
        if ($rs) {
            ...
            if ($fila) {
                ...
                $idUsuario = new Usuario($fila['nombre'], $fila['apellido'], $fila['nombre_usuario'], $fila['correo'], $fila['clave'], $fila['imagen'], $fila['rol']);
    ...
    public static function update($id_usuario, $nombre, $apellido, $nombreUsuario, $id_imagen)
    {
        $result = false;
        $conn = Aplicacion::getInstance()->getConexionBd();
