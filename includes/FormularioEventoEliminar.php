...
class FormularioEventoEliminar extends Formulario {
    ...
    protected function generaCamposFormulario(&$datosIniciales) {
        ...
        $mensajeError = '';
        if (in_array("Es necesario seleccionar un evento.", $this->errores)) {
            $mensajeError = '<span class="error">Es necesario seleccionar un evento. Vuélvelo a intentar</span>';
    ...
    protected function procesaFormulario(&$datos) {
        ...
        if (count($this->errores) === 0) {
            ...
            if ( !$evento ) {
                 $this->errores[]= "Es necesario seleccionar un evento.";
            } else {
                echo"si";
