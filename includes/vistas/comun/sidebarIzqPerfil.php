...
?>
    ...
    <aside id="sideBarIzq">
        ...
        <div class="sidebar bar-block light-grey" style="width:20%">
            <div class="container dark-grey">Mi Perfil</div>

            <img src="<?=$ruta?>" alt="ImgUser" style="width:80%">
            <a href="perfil.php" class="bar-item button blue">Usuario:  <?=$_SESSION["nombreUsuario"]?></a>
            
            <?php if (isset($_SESSION['admin'])) { ?>
            <a href="perfilMisPost.php" class="bar-item button">Mis Post<span class="tag blue right margin-right"><?=$numPost?></span></a><?php 
            }
            else{?>
