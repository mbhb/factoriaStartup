    ...
    <header id="cabeceraInicio">
        ...
        <div id="columnas">
            ...
            <div class="columna2">
                <nav class="navbar">
                    <ul>
                        <li><a href="index.php" id="img"><img src="<?= RUTA_IMGS . '/logo2.jpeg' ?>" alt="Logo de Factoria"></a></li>
                        <li><a href="index.php">FactoríaStartUp</a></li>
                        ...
                        <?php if (isset($_SESSION['login'])) { 
                            ...
                            <?php if (isset($_SESSION['admin'])) {   ?>
                                ...
                                <li><a href='calendarioMostrarAdmin.php'>Eventos</a></li>
                                <li><a href='proyectosMostrarAdmin.php'>Proyectos</a></li>
